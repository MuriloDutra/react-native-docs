...
import { TouchableNativeFeedback, TouchableOpacity, TouchableHighlight, Platform, Text, View, StyleSheet } from 'react-native'

const SUPPORTS_NATIVE_FEEDBACK = Platform.OS === 'android' && Platform.Version >= 21
const noop = () => {}
const defaultHitSlop = { top: 15, bottom: 15, left: 15,right: 15 }

export default class AndroidRipple extends React.Component {
    render(){
        return (
